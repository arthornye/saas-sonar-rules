 ...
 */
public class SaasRulesDefinition implements RulesDefinition {

  // don't change that because the path is hard coded in CheckVerifier
  private static final String RESOURCE_BASE_PATH = "/org/sonar/l10n/java/rules/squid";

  public static final String REPOSITORY_KEY = "saas-java";
  ...
  public void define(Context context) {
    NewRepository repository = context
      ...
      .setName("SaaS Custom Repository");

    List<Class> checks = SaasRulesList.getChecks();
  ...
  private void addMetadata(NewRule rule, String metadataKey) {
    URL resource = SaasRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
    if (resource != null) {
  ...
  private static void addHtmlDescription(NewRule rule, String metadataKey) {
    URL resource = SaasRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
    if (resource != null) {
