...
import com.souche.rules.entry.SaasRulesDefinition;
import com.souche.rules.entry.SaasRulesList;

public class MyJavaRulesDefinitionTest {

  @Test
  public void test() {
    SaasRulesDefinition rulesDefinition = new SaasRulesDefinition();
    RulesDefinition.Context context = new RulesDefinition.Context();
    rulesDefinition.define(context);
    RulesDefinition.Repository repository = context.repository(SaasRulesDefinition.REPOSITORY_KEY);

    assertThat(repository.name()).isEqualTo("SaaS Custom Repository");
    assertThat(repository.language()).isEqualTo("java");
    assertThat(repository.rules()).hasSize(SaasRulesList.getChecks().size());
